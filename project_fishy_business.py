...
def init():
        glClearColor(0.0, 0.4, 0.6, 1.0)  # Black background
...
def keyboard(key, x, y):
    global quit
    global shooter_position, shooter_position_y
...
def display():
    global my_fish_score, higher_power, miss_shot
